...
/**
 * A {@link Factory} for the {@link DefaultConnectorSenderModule} object.
 */
class DefaultConnectorSenderModuleFactory implements Factory {

    @Override
    public Object create() {

        return new DefaultConnectorSenderModule();
    }
